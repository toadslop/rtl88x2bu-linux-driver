...
const struct ch_list_t rtw_channel_def_2g[] = {
...
const struct ch_list_t rtw_channel_def_5g[] = {
...
static u8 chdef_ch(const struct ch_list_t *cl, u8 i)
{
	return cl->len_ch_attr[i + 1];
}

static u8 chdef_attrib(const struct ch_list_t *cl)
{
	return cl->len_ch_attr[chdef_len(cl) + 1];
}

u8 rtw_chdef_2g_len(u8 chd)
{
	if (chd >= RTW_CHD_2G_MAX)
		return 0;
	return chdef_len(&rtw_channel_def_2g[chd]);
}
...
u8 rtw_chdef_2g_ch(u8 chd, u8 i)
{
	if (chd >= RTW_CHD_2G_MAX)
		return 0;
	return chdef_ch(&rtw_channel_def_2g[chd], i);
}
...
u8 rtw_chdef_2g_attrib(u8 chd)
{
	if (chd >= RTW_CHD_2G_MAX)
		return 0;
	return chdef_attrib(&rtw_channel_def_2g[chd]);
}

#if CONFIG_IEEE80211_BAND_5GHZ
u8 rtw_chdef_5g_len(u8 chd)
{
	if (chd >= RTW_CHD_5G_MAX)
		return 0;
	return chdef_len(&rtw_channel_def_5g[chd]);
}
...
u8 rtw_chdef_5g_ch(u8 chd, u8 i)
{
	if (chd >= RTW_CHD_5G_MAX)
		return 0;
	return chdef_ch(&rtw_channel_def_5g[chd], i);
}
