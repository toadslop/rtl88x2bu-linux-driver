...
extern void update_current_network(_adapter *adapter, WLAN_BSSID_EX *pnetwork);
...
/* Unassoc STA queue: del/search/rx_add/interested/undo in core/rtw_mlme_rest.c (W3-62). */
...
/* rtw_restruct_wmm_ie, PMKID helpers, rtw_restruct_sec_ie → rtw_mlme_rest.c (W3-63). */
