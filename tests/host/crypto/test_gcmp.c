...
/*
 * Host L2 oracle runner for gcmp.c (W2-02).
 *
...
static int json_parse_fn_dispatch(const char *obj, size_t obj_len,
				  const char *key, enum gcmp_fn *out)
{
	char buf[64];
