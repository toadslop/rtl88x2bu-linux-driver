...
//! AES internal tables + key schedule — Rust port of `core/crypto/aes-internal.c` (W2-11…W2-14).
//! Driver builds with `AES_SMALL_TABLES` (see `aes_i.h`).
...
pub extern "C" fn rtw_rust_aes_internal_probe() -> core::ffi::c_int {
    Te0[0] as core::ffi::c_int + Td0[0] as core::ffi::c_int
}
