...
#![allow(dead_code, improper_ctypes, non_snake_case, non_camel_case_types, non_upper_case_globals, unreachable_pub, missing_docs)]
...
extern "C" {
    ...
    fn issue_del_ba_ex(a: *mut Adapter, ra: *mut U8, tid: U8, reason: U16, ini: U8, tc: c_int, wm: c_int) -> c_int;
    ...
    #[cfg(config_tdls)] fn rtw_rust_peer_rx_tdls_disc(s: *mut StaInfo) -> U64;
    #[cfg(config_tdls)] fn rtw_rust_peer_last_rx_tdls_disc(s: *mut StaInfo) -> U64;
}
...
unsafe fn peer_rx_alive(psta: *mut StaInfo, null_ret: U8) -> U8 {
    ...
    unsafe { rtw_rust_peer_sta_update_last_rx(psta); }
    if alive { _TRUE as U8 } else { _FALSE as U8 }
}

#[no_mangle] pub extern "C" fn chk_ap_is_alive(padapter: *mut Adapter, psta: *mut StaInfo) -> U8 {
    let _ = padapter;
    unsafe { peer_rx_alive(psta, _FALSE as U8) }
}

#[no_mangle] pub extern "C" fn chk_adhoc_peer_is_alive(psta: *mut StaInfo) -> U8 {
    unsafe { peer_rx_alive(psta, _TRUE as U8) }
}

#[cfg(config_tdls)]
#[no_mangle] pub extern "C" fn chk_tdls_peer_sta_is_alive(padapter: *mut Adapter, psta: *mut StaInfo) -> U8 {
    let _ = padapter;
    if psta.is_null() {
        return _TRUE as U8;
    }
...
#[no_mangle] pub extern "C" fn rtw_delba_check(padapter: *mut Adapter, psta: *mut StaInfo, from_timer: U8) {
